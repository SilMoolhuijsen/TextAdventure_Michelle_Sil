...
Left_HG = "You left the handgun on the ground"

atTools = "You made it to the tools.\n\n"

TheTools = "There's screwdrivers, hammers and crowbars.\n\n"

Tools_NotFreed = "But unfortunately, you aren't able to grab any of them now. You'll need to free yourself first."

ChooseTool = "You're only able to hold one tool at a time. Which tool will you grab?\nA. Screwdriver\nB. Hammer\nC. Crowbar\n"
...
SwitchTool = "Would you like to switch?\n"
...
NoTable = "You can't move the table. It has been screwed to the wall."
